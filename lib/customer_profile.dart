          ...
          body: Column(
            children: [
              ...
              Container(
                ...
                child: Padding(
                  padding: const EdgeInsets.only(top: 3, left: 14, bottom: 10),
                  child: Column(
                    mainAxisAlignment: MainAxisAlignment.spaceAround,
                    children: [
                      Row(
                        crossAxisAlignment: CrossAxisAlignment
                            .center, // Alinha verticalmente ao centro
                        children: [
                          Image.asset(
                            AppImages.whatsapp,
                            color: Colors.white,
                          ...
                          Column(
                            ...
                            children: [
                              ...
                              Container(
                                ...
                                decoration: BoxDecoration(
                                  color: Colors.grey[
                                      700], // Cor de fundo atrás do número
                      ...
                      Row(
                        ...
                        children: [
                          Image(
                            image: AssetImage(AppImages.idCard),
                            color: Colors.white,
                            fit: BoxFit.fitWidth,
                            height: 36,
                            width: 36,
                          ...
                          Column(
                            ...
                            children: [
                              ...
                              Container(
                                ...
                                decoration: BoxDecoration(
                                  color: Colors
                                      .grey[700], // Cor de fundo atrás do CPF
                                  borderRadius: BorderRadius.circular(
                                      8), // Borda arredondada
                                ),
                                child: const Text(
